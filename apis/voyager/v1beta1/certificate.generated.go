...
const (
	// ----- content types ----
	codecSelferC_UTF89193 = 1
	codecSelferC_RAW9193  = 0
	// ----- value types used ----
	codecSelferValueTypeArray9193 = 10
	codecSelferValueTypeMap9193   = 9
	// ----- containerStateValues ----
	codecSelfer_containerMapKey9193    = 2
	codecSelfer_containerMapValue9193  = 3
	codecSelfer_containerMapEnd9193    = 4
	codecSelfer_containerArrayElem9193 = 6
	codecSelfer_containerArrayEnd9193  = 7
)

var (
	codecSelferBitsize9193                         = uint8(reflect.TypeOf(uint(0)).Bits())
	codecSelferOnlyMapOrArrayEncodeToStructErr9193 = errors.New(`only encoded map or array can be decoded into a struct`)
)

type codecSelfer9193 struct{}
...
func (x *Certificate) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayElem9193)
				if yyq2[0] {
					yym4 := z.EncBinary()
					_ = yym4
					if false {
					} else {
						r.EncodeString(codecSelferC_UTF89193, string(x.Kind))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
			} else {
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("kind"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.APIVersion))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("apiVersion"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("metadata"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yy12 := &x.ObjectMeta
					yym13 := z.EncBinary()
					_ = yym13
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("spec"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yy17 := &x.Spec
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("status"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yy22 := &x.Status
			...
			if yyr2 || yy2arr2 {
				z.EncSendContainerState(codecSelfer_containerArrayEnd9193)
			} else {
				z.EncSendContainerState(codecSelfer_containerMapEnd9193)
			}
		}
	}
}
...
func (x *Certificate) CodecDecodeSelf(d *codec1978.Decoder) {
	...
	if false {
		...
		if yyct2 == codecSelferValueTypeMap9193 {
			yyl2 := r.ReadMapStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerMapEnd9193)
			} else {
				x.codecDecodeSelfFromMap(yyl2, d)
			}
		} else if yyct2 == codecSelferValueTypeArray9193 {
			yyl2 := r.ReadArrayStart()
			if yyl2 == 0 {
				z.DecSendContainerState(codecSelfer_containerArrayEnd9193)
			} else {
				x.codecDecodeSelfFromArray(yyl2, d)
			}
		} else {
			panic(codecSelferOnlyMapOrArrayEncodeToStructErr9193)
		}
	}
}
...
func (x *Certificate) codecDecodeSelfFromMap(l int, d *codec1978.Decoder) {
	...
	for yyj3 := 0; ; yyj3++ {
		...
		z.DecSendContainerState(codecSelfer_containerMapKey9193)
		yys3Slc = r.DecodeBytes(yys3Slc, true, true)
		yys3 := string(yys3Slc)
		z.DecSendContainerState(codecSelfer_containerMapValue9193)
		switch yys3 {
		case "kind":
			if r.TryDecodeAsNil() {
				x.Kind = ""
...
func (x *Certificate) codecDecodeSelfFromArray(l int, d *codec1978.Decoder) {
	...
	z.DecSendContainerState(codecSelfer_containerArrayElem9193)
	if r.TryDecodeAsNil() {
		x.Kind = ""
	} else {
		yyv13 := &x.Kind
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("domains"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.Domains == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey9193)
				r.EncodeString(codecSelferC_UTF89193, string("challengeProvider"))
				z.EncSendContainerState(codecSelfer_containerMapValue9193)
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF89193, string(x.ACMEUserSecretName))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey9193)
				r.EncodeString(codecSelferC_UTF89193, string("acmeUserSecretName"))
				z.EncSendContainerState(codecSelfer_containerMapValue9193)
				yym13 := z.EncBinary()
				_ = yym13
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("storage"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yy17 := &x.Storage
					yy17.CodecEncodeSelf(e)
				}
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[4] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.Provider))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[4] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("provider"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym21 := z.EncBinary()
					_ = yym21
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[5] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.Email))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[5] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("email"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym24 := z.EncBinary()
					_ = yym24
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("httpProviderIngressReference"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[7] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.ProviderCredentialSecretName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[7] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("providerCredentialSecretName"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym32 := z.EncBinary()
					_ = yym32
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[8] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.ACMEServerURL))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[8] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("acmeStagingURL"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym35 := z.EncBinary()
					_ = yym35
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("http"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.HTTP == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("dns"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.DNS == nil {
						r.EncodeNil()
					} else {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("ingress"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yy6 := &x.Ingress
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.CredentialSecretName))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("credentialSecretName"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("secret"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.Secret == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("vault"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.Vault == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.Name))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("name"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.Prefix))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("prefix"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("creationTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.CreationTime == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("conditions"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.Conditions == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("lastIssuedCertificate"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.LastIssuedCertificate == nil {
						r.EncodeNil()
					} else {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("certificateObtained"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym14 := z.EncBinary()
					_ = yym14
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF89193, string(x.Message))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey9193)
				r.EncodeString(codecSelferC_UTF89193, string("message"))
				z.EncSendContainerState(codecSelfer_containerMapValue9193)
				yym17 := z.EncBinary()
				_ = yym17
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[6] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("details"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.Details == nil {
						r.EncodeNil()
					} else {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF89193, string(x.Domain))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey9193)
				r.EncodeString(codecSelferC_UTF89193, string("domain"))
				z.EncSendContainerState(codecSelfer_containerMapValue9193)
				yym5 := z.EncBinary()
				_ = yym5
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF89193, string(x.CertURL))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey9193)
				r.EncodeString(codecSelferC_UTF89193, string("certUrl"))
				z.EncSendContainerState(codecSelfer_containerMapValue9193)
				yym8 := z.EncBinary()
				_ = yym8
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if false {
					...
					r.EncodeString(codecSelferC_UTF89193, string(x.CertStableURL))
				}
			} else {
				z.EncSendContainerState(codecSelfer_containerMapKey9193)
				r.EncodeString(codecSelferC_UTF89193, string("certStableUrl"))
				z.EncSendContainerState(codecSelfer_containerMapValue9193)
				yym11 := z.EncBinary()
				_ = yym11
				if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.AccountRef))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("accountRef"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym14 := z.EncBinary()
					_ = yym14
					if false {
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[0] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.SerialNumber))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[0] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("serialNumber"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym5 := z.EncBinary()
					_ = yym5
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("notBefore"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yy9 := &x.NotBefore
					yym10 := z.EncBinary()
					_ = yym10
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[2] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("notAfter"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yy14 := &x.NotAfter
					yym15 := z.EncBinary()
					_ = yym15
...
func (x RequestConditionType) CodecEncodeSelf(e *codec1978.Encoder) {
	...
	if false {
		...
		r.EncodeString(codecSelferC_UTF89193, string(x))
	}
}
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				z.EncSendContainerState(codecSelfer_containerMapKey9193)
				r.EncodeString(codecSelferC_UTF89193, string("type"))
				z.EncSendContainerState(codecSelfer_containerMapValue9193)
				x.Type.CodecEncodeSelf(e)
			}
			if yyr2 || yy2arr2 {
				...
				if yyq2[1] {
					...
					if false {
						...
						r.EncodeString(codecSelferC_UTF89193, string(x.Reason))
					}
				} else {
					r.EncodeString(codecSelferC_UTF89193, "")
				}
				...
				if yyq2[1] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("reason"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					yym8 := z.EncBinary()
					_ = yym8
					if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("lastUpdateTime"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
	...
	if x == nil {
		...
		if false {
			...
			if yyr2 || yy2arr2 {
				...
				if yyq2[3] {
					z.EncSendContainerState(codecSelfer_containerMapKey9193)
					r.EncodeString(codecSelferC_UTF89193, string("items"))
					z.EncSendContainerState(codecSelfer_containerMapValue9193)
					if x.Items == nil {
						r.EncodeNil()
					} else {
...
func (x codecSelfer9193) encSliceCertificateCondition(v []CertificateCondition, e *codec1978.Encoder) {
	var h codecSelfer9193
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
...
func (x codecSelfer9193) decSliceCertificateCondition(v *[]CertificateCondition, d *codec1978.Decoder) {
	var h codecSelfer9193
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
...
func (x codecSelfer9193) encSliceCertificate(v []Certificate, e *codec1978.Encoder) {
	var h codecSelfer9193
	z, r := codec1978.GenHelperEncoder(e)
	_, _, _ = h, z, r
	r.EncodeArrayStart(len(v))
...
func (x codecSelfer9193) decSliceCertificate(v *[]Certificate, d *codec1978.Decoder) {
	var h codecSelfer9193
	z, r := codec1978.GenHelperDecoder(d)
	_, _, _ = h, z, r
